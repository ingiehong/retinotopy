...
global Pstate
%ddir='Master\Stimulator_master'
ddir = [fileparts(which('Retinotopy_Master')) filesep 'Stimulator_master' filesep 'ParamFiles'];
...
[file path] = uiputfile('*.param','Save as', [fileparts(which('Retinotopy_Master')) filesep 'Stimulator_master' filesep 'ParamFiles'] );
